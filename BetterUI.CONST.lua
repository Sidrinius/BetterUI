...
BUI.CONST.CraftingSkillTypes = { CRAFTING_TYPE_BLACKSMITHING, CRAFTING_TYPE_CLOTHIER, CRAFTING_TYPE_JEWELRYCRAFTING, CRAFTING_TYPE_WOODWORKING }
BUI.CONST.armorCraftMap = { [ARMORTYPE_NONE] = CRAFTING_TYPE_JEWELRYCRAFTING, [ARMORTYPE_LIGHT] = CRAFTING_TYPE_CLOTHIER, [ARMORTYPE_MEDIUM] = CRAFTING_TYPE_CLOTHIER, [ARMORTYPE_HEAVY] = CRAFTING_TYPE_BLACKSMITHING }
...
BUI.CONST.armorRImap = { [ARMORTYPE_NONE] = { [EQUIP_TYPE_NECK] = 1, [EQUIP_TYPE_RING] = 2 },
...
BUI_GAMEPAD_DEFAULT_PANEL_WIDTH = 1350
BUI_ZO_GAMEPAD_DEFAULT_PANEL_WIDTH = 470
BUI_GAMEPAD_DEFAULT_HORIZ_PADDING = 36
BUI_GAMEPAD_DEFAULT_HORIZ_PADDING_OTHER = 10
...
--** TAB BAR WIDTH
BUI_GAMEPAD_DEFAULT_PANEL_CONTAINER_WIDTH = 1325
-- Quadrant 1
